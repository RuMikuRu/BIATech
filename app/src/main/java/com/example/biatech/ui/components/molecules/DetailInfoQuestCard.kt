...
import com.example.biatech.ui.components.atom.PrimaryTextHeading
import com.example.biatech.ui.components.atom.PrimaryTextHref

@Composable
fun DetailInfoQuestCard(modifier: Modifier = Modifier) {
    Card(
